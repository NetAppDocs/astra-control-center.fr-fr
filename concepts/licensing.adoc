...
* link:../concepts/licensing.html["Si vous avez déjà acheté Astra Control Center, générez votre fichier de licence NetApp (NLF)"^] Sur le site de support NetApp. Après avoir acheté le produit, vous recevez un numéro de série et une licence que vous utilisez sur le site de support.
