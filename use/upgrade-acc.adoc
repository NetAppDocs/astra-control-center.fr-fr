...
----
+
Reportez-vous à la section https://["Documentation Astra Trident"] pour effectuer une mise à niveau à partir d'une ancienne version.
...
. Accédez au https://["Page de téléchargement des produits Astra Control Center"^] Sur le site de support NetApp. Vous pouvez sélectionner la dernière version ou une autre version souhaitée dans le menu déroulant.
