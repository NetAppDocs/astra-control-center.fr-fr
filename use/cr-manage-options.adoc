...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource["Définissez une application à l'aide d'une ressource personnalisée Kubernetes"]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource["Gérez un compartiment à l'aide d'une ressource personnalisée"]
