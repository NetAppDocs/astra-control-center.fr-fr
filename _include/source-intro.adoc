...
** Pour les clusters AKS, Astra Control Service utilise https://["Azure NetApp Files"^] Ou des disques gérés Azure en tant que backend de stockage pour les volumes persistants.
