...
+
** Pour les clusters GKE, Astra Control Service utilise  https://www.netapp.com/google-cloud/netapp-volumes/["NetApp Cloud Volumes Service pour Google Cloud"^] ou Google Persistent Disks comme système de stockage pour vos volumes persistants.
** Pour les clusters AKS, Astra Control Service utilise  https://www.netapp.com/azure/azure-netapp-files/["Azure NetApp Files"^] ou des disques gérés par Azure comme backend de stockage pour vos volumes persistants.
