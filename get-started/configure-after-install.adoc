...
----
. Appliquez le fichier de ressources suivant pour configurer l'objet de stratégie réseau-acc-avp pour permettre aux services de plug-in Astra d'effectuer des demandes vers les services du centre de contrôle Astra. Remplacez entre parenthèses <> par les informations relatives à votre environnement :
+
[source, yaml]
----
