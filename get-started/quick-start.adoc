...
* link:../get-started/requirements.html#astra-trident-requirements["Assurez-vous que votre environnement inclut une version d'Astra Trident prise en charge"^]
* link:../use/enable-acp.html["Activez les fonctionnalités avancées de provisionnement du stockage et de gestion Astra Control"^]
