...
[role="lead"]
Si vous utilisez Red Hat OpenShift, vous pouvez installer Astra Control Center à l'aide de l'opérateur certifié Red Hat. Utiliser cette procédure pour installer le centre de contrôle Astra à partir du https://["Catalogue de l'écosystème Red Hat"^] Ou utilisez Red Hat OpenShift Container Platform.
...
+
... Sélectionnez le centre de contrôle NetApp Astra https://["opérateur"^].
...
.. Entrez la version d'Astra Control Center, par exemple 23.04.0-22.
