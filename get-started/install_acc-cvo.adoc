...
Voir https://["Identifiants AWS initiaux"^].
...
Pour obtenir des instructions d'installation, reportez-vous à la section https://["Installation d'un cluster sur AWS dans OpenShift Container Platform"^].
...
Suivez la documentation AWS pour suivre la procédure ci-dessous. Voir https://["Documentation d'installation d'AWS"^].
...
* https://["Mise en route de Cloud Volumes ONTAP dans AWS"^].
* https://["Créez un connecteur dans AWS à l'aide de BlueXP"^]
...
* https://["Installation d'un cluster OpenShift dans GCP"^]
* https://["Création d'un compte de service GCP"^]
...
Voir https://["Identifiants et autorisations GCP initiaux"^].
...
Suivez la documentation BlueXP pour effectuer les étapes suivantes. Voir https://["Mise en route de Cloud Volumes ONTAP dans GCP"^].
...
.Étapes
. Ajoutez vos informations d'identification à BlueXP. Voir https://["Ajout de comptes GCP"^].
. Ajoutez un connecteur pour GCP.
+
.. Choisissez GCP comme fournisseur.
.. Entrez les identifiants GCP. Voir https://["Création d'un connecteur dans GCP à partir de BlueXP"^].
...
Voir link:../get-started/requirements.html["Exigences relatives à l'environnement opérationnel d'Astra Control Center"].
...
* https://["Installation du cluster OpenShift sur Azure"^].
* https://["Installation d'un compte Azure"^].
...
Voir https://["Identifiants et autorisations Azure"^].
...
Suivez la documentation Azure pour suivre les étapes ci-dessous. Voir https://["Installation du cluster OpenShift sur Azure"^].
...
Suivez la documentation BlueXP pour effectuer les étapes suivantes. Voir https://["Mise en route de BlueXP dans Azure"^].
...
.Étapes
. Ajoutez vos informations d'identification à BlueXP.
. Ajoutez un connecteur pour Azure. Voir https://["Politiques BlueXP"^].
+
...
+
Voir https://["Création d'un connecteur dans Azure à partir de BlueXPr"^].
